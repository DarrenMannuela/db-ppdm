...
cursor.execute("""
    begin
        execute immediate 'drop table r_source';
        exception when others then if sqlcode <> -942 then raise; end if;
    end;""")

cursor.execute("""
    create table r_source (
        SOURCE VARCHAR(40) PRIMARY KEY NOT NULL,
        ...
        CONSTRAINT FK_Source FOREIGN KEY(ROW_SOURCE) 
        REFERENCES R_SOURCE(SOURCE),
        CONSTRAINT FK_Source_RowQuality FOREIGN KEY(ROW_QUALITY) 
