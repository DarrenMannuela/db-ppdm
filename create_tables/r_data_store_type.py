...
cursor.execute("""
    begin
        execute immediate 'drop table r_data_store_type';
        exception when others then if sqlcode <> -942 then raise; end if;
    end;""")

cursor.execute("""
    create table r_data_store_type(
        DATA_STORE_TYPE VARCHAR(40) PRIMARY KEY NOT NULL,
        ...
        CONSTRAINT FK_DataStoreType_Source FOREIGN KEY(SOURCE) 
        REFERENCES R_SOURCE(SOURCE),
        CONSTRAINT FK_DataStoreType_RowQuality FOREIGN KEY(ROW_QUALITY) 
