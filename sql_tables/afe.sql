CREATE TABLE BIBLIOGRAPHY_TABLE_AFE (
    ...
    KKKS_NAME VARCHAR2(255),
    WORKING_AREA VARCHAR2(255),
    SUBMISSION_TYPE VARCHAR2(255),
    DATA_TYPE VARCHAR2(255) DEFAULT 'BIBLIOGRAPHY',
    USER_ID NUMBER,
    ...
    CONSTRAINT FK_BIBLIOGRAPHY_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
    );
    CREATE TABLE PRINT_WELL_REPORT_TABLE_AFE (
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'PRINT_WELL_REPORT',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_PRINT_WELL_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_PRINT_WELL_REPORT_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'DIGITAL_MAPS_AND_TECHNICAL_DRAWING',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_DIGITAL_MAPS_AND_TECHNICAL_DRAWING_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_MAPS_AND_TECHNICAL_DRAWING_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '3D_SEISMIC_FIELD_DATA_STORED_IN_MEDIA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T3D_SEISMIC_FIELD_DATA_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_FIELD_DATA_STORED_IN_MEDIA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'DIGITAL_WELL_REPORT',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_DIGITAL_WELL_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_WELL_REPORT_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'DIGITAL_IMAGE_WELL_LOG',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_DIGITAL_IMAGE_WELL_LOG_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_IMAGE_WELL_LOG_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'DIGITAL_2D_3D_SEISMIC_REPORT',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_DIGITAL_2D_3D_SEISMIC_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_2D_3D_SEISMIC_REPORT_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '3D_SEISMIC_PROCESS_DATA_STORED_IN_MEDIA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T3D_SEISMIC_PROCESS_DATA_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_PROCESS_DATA_STORED_IN_MEDIA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'WORKING_AREA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_WORKING_AREA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WORKING_AREA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'DIGITAL_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_REPORT',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_DIGITAL_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_REPORT_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '2D_SEISMIC_SECTION',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T2D_SEISMIC_SECTION_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_SECTION_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '2D_SEISMIC_DIGITAL_PROCESSED_DATA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T2D_SEISMIC_DIGITAL_PROCESSED_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_DIGITAL_PROCESSED_DATA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'WELL_CORE_SAMPLE',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_WELL_CORE_SAMPLE_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WELL_CORE_SAMPLE_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'PRINT_TECHNICAL_REPORT',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_PRINT_TECHNICAL_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_PRINT_TECHNICAL_REPORT_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_REPORT',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_REPORT_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '3D_SEISMIC_NAVIGATION_DIGITAL_DATA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T3D_SEISMIC_NAVIGATION_DIGITAL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_NAVIGATION_DIGITAL_DATA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'PROJECT_FILE_STORED_IN_MEDIA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_PROJECT_FILE_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_PROJECT_FILE_STORED_IN_MEDIA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '2D_SEISMIC_FIELD_DATA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T2D_SEISMIC_FIELD_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_FIELD_DATA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'WELL_LOGS',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_WELL_LOGS_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WELL_LOGS_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DIGITAL_DATA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DIGITAL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DIGITAL_DATA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '2D_SEISMIC_NAVIGATION_DATA_STORED_IN_MEDIA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T2D_SEISMIC_NAVIGATION_DATA_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_NAVIGATION_DATA_STORED_IN_MEDIA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '2D_3D_SEISMIC_REPORT',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T2D_3D_SEISMIC_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_3D_SEISMIC_REPORT_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'DIGITAL_WELL_LOG',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_DIGITAL_WELL_LOG_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_WELL_LOG_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '3D_SEISMIC_PROCESSED_DIGITAL_DATA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T3D_SEISMIC_PROCESSED_DIGITAL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_PROCESSED_DIGITAL_DATA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '2D_SEISMIC_FIELD_DIGITAL_DATA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T2D_SEISMIC_FIELD_DIGITAL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_FIELD_DIGITAL_DATA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DATA_STORED_IN_MEDIA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DATA_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DATA_STORED_IN_MEDIA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '3D_SEISMIC_SUMMARY',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T3D_SEISMIC_SUMMARY_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_SUMMARY_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '3D_SEISMIC_NAVIGATION_DATA_STORED_IN_MEDIA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T3D_SEISMIC_NAVIGATION_DATA_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_NAVIGATION_DATA_STORED_IN_MEDIA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DATA_SUMMARY',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DATA_SUMMARY_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DATA_SUMMARY_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '2D_SEISMIC_SUMMARY',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T2D_SEISMIC_SUMMARY_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_SUMMARY_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'WELL_SAMPLES',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_WELL_SAMPLES_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WELL_SAMPLES_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'PRINT_MAPS_AND_TECHNICAL_DRAWING',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_PRINT_MAPS_AND_TECHNICAL_DRAWING_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_PRINT_MAPS_AND_TECHNICAL_DRAWING_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '2D_SEISMIC_PROCESS_DATA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T2D_SEISMIC_PROCESS_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_PROCESS_DATA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '2D_SEISMIC_NAVIGATION_DIGITAL_DATA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T2D_SEISMIC_NAVIGATION_DIGITAL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_NAVIGATION_DIGITAL_DATA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'WELL_DATA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_WELL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WELL_DATA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'WELL_SEISMIC_PROFILE_DATA_STORED_IN_MEDIA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_WELL_SEISMIC_PROFILE_DATA_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WELL_SEISMIC_PROFILE_DATA_STORED_IN_MEDIA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'FIELD_INFORMATION',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_FIELD_INFORMATION_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_FIELD_INFORMATION_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'DIGITAL_TECHNICAL_REPORT',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_DIGITAL_TECHNICAL_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_TECHNICAL_REPORT_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'BASIN',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_BASIN_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_BASIN_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'WELL_SEISMIC_PROFILE_DIGITAL',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_WELL_SEISMIC_PROFILE_DIGITAL_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WELL_SEISMIC_PROFILE_DIGITAL_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'DIGITAL_PROJECT_FILE',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_DIGITAL_PROJECT_FILE_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_PROJECT_FILE_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'OUTCROP_SAMPLE',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_OUTCROP_SAMPLE_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_OUTCROP_SAMPLE_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT '3D_SEISMIC_FIELD_DIGITAL_DATA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_T3D_SEISMIC_FIELD_DIGITAL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_FIELD_DIGITAL_DATA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'SEISMIC_INTERPRETATION_DATA',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_SEISMIC_INTERPRETATION_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_SEISMIC_INTERPRETATION_DATA_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
                ...
                WORKING_AREA VARCHAR2(255),
                SUBMISSION_TYPE VARCHAR2(255),
                DATA_TYPE VARCHAR2(255) DEFAULT 'DIGITAL_2D_SEISMIC_SECTION',
                USER_ID NUMBER,
                ...
                CONSTRAINT FK_DIGITAL_2D_SEISMIC_SECTION_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_2D_SEISMIC_SECTION_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS(ID)
                );
