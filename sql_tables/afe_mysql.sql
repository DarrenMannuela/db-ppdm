CREATE TABLE BIBLIOGRAPHY_AFE (
    ...
    CONSTRAINT FK_BIBLIOGRAPHY_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
    );
    CREATE TABLE PRINT_WELL_REPORT_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_PRINT_WELL_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_PRINT_WELL_REPORT_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE DIGITAL_MAPS_AND_TECHNICAL_DRAWING_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_DIGITAL_MAPS_AND_TECHNICAL_DRAWING_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_MAPS_AND_TECHNICAL_DRAWING_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T3D_SEISMIC_FIELD_DATA_STORED_IN_MEDIA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T3D_SEISMIC_FIELD_DATA_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_FIELD_DATA_STORED_IN_MEDIA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE DIGITAL_WELL_REPORT_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_DIGITAL_WELL_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_WELL_REPORT_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE DIGITAL_IMAGE_WELL_LOG_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_DIGITAL_IMAGE_WELL_LOG_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_IMAGE_WELL_LOG_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE DIGITAL_2D_3D_SEISMIC_REPORT_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_DIGITAL_2D_3D_SEISMIC_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_2D_3D_SEISMIC_REPORT_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T3D_SEISMIC_PROCESS_DATA_STORED_IN_MEDIA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T3D_SEISMIC_PROCESS_DATA_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_PROCESS_DATA_STORED_IN_MEDIA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE WORKING_AREA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_WORKING_AREA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WORKING_AREA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE DIGITAL_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_REPORT_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_DIGITAL_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_REPORT_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T2D_SEISMIC_SECTION_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T2D_SEISMIC_SECTION_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_SECTION_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T2D_SEISMIC_DIGITAL_PROCESSED_DATA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T2D_SEISMIC_DIGITAL_PROCESSED_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_DIGITAL_PROCESSED_DATA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE WELL_CORE_SAMPLE_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_WELL_CORE_SAMPLE_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WELL_CORE_SAMPLE_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE PRINT_TECHNICAL_REPORT_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_PRINT_TECHNICAL_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_PRINT_TECHNICAL_REPORT_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_REPORT_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_REPORT_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T3D_SEISMIC_NAVIGATION_DIGITAL_DATA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T3D_SEISMIC_NAVIGATION_DIGITAL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_NAVIGATION_DIGITAL_DATA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE PROJECT_FILE_STORED_IN_MEDIA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_PROJECT_FILE_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_PROJECT_FILE_STORED_IN_MEDIA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T2D_SEISMIC_FIELD_DATA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T2D_SEISMIC_FIELD_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_FIELD_DATA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE WELL_LOGS_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_WELL_LOGS_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WELL_LOGS_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DIGITAL_DATA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DIGITAL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DIGITAL_DATA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T2D_SEISMIC_NAVIGATION_DATA_STORED_IN_MEDIA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T2D_SEISMIC_NAVIGATION_DATA_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_NAVIGATION_DATA_STORED_IN_MEDIA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T2D_3D_SEISMIC_REPORT_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T2D_3D_SEISMIC_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_3D_SEISMIC_REPORT_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE DIGITAL_WELL_LOG_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_DIGITAL_WELL_LOG_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_WELL_LOG_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T3D_SEISMIC_PROCESSED_DIGITAL_DATA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T3D_SEISMIC_PROCESSED_DIGITAL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_PROCESSED_DIGITAL_DATA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T2D_SEISMIC_FIELD_DIGITAL_DATA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T2D_SEISMIC_FIELD_DIGITAL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_FIELD_DIGITAL_DATA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DATA_STORED_IN_MEDIA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DATA_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DATA_STORED_IN_MEDIA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T3D_SEISMIC_SUMMARY_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T3D_SEISMIC_SUMMARY_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_SUMMARY_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T3D_SEISMIC_NAVIGATION_DATA_STORED_IN_MEDIA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T3D_SEISMIC_NAVIGATION_DATA_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_NAVIGATION_DATA_STORED_IN_MEDIA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DATA_SUMMARY_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DATA_SUMMARY_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_NON_SEISMIC_AND_SEISMIC_NON_CONVENTIONAL_DATA_SUMMARY_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T2D_SEISMIC_SUMMARY_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T2D_SEISMIC_SUMMARY_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_SUMMARY_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE WELL_SAMPLES_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_WELL_SAMPLES_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WELL_SAMPLES_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE PRINT_MAPS_AND_TECHNICAL_DRAWING_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_PRINT_MAPS_AND_TECHNICAL_DRAWING_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_PRINT_MAPS_AND_TECHNICAL_DRAWING_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T2D_SEISMIC_PROCESS_DATA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T2D_SEISMIC_PROCESS_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_PROCESS_DATA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T2D_SEISMIC_NAVIGATION_DIGITAL_DATA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T2D_SEISMIC_NAVIGATION_DIGITAL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T2D_SEISMIC_NAVIGATION_DIGITAL_DATA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE WELL_DATA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_WELL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WELL_DATA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE WELL_SEISMIC_PROFILE_DATA_STORED_IN_MEDIA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_WELL_SEISMIC_PROFILE_DATA_STORED_IN_MEDIA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WELL_SEISMIC_PROFILE_DATA_STORED_IN_MEDIA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE FIELD_INFORMATION_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_FIELD_INFORMATION_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_FIELD_INFORMATION_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE DIGITAL_TECHNICAL_REPORT_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_DIGITAL_TECHNICAL_REPORT_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_TECHNICAL_REPORT_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE BASIN_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_BASIN_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_BASIN_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE WELL_SEISMIC_PROFILE_DIGITAL_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_WELL_SEISMIC_PROFILE_DIGITAL_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_WELL_SEISMIC_PROFILE_DIGITAL_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE DIGITAL_PROJECT_FILE_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_DIGITAL_PROJECT_FILE_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_PROJECT_FILE_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE OUTCROP_SAMPLE_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_OUTCROP_SAMPLE_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_OUTCROP_SAMPLE_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE T3D_SEISMIC_FIELD_DIGITAL_DATA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_T3D_SEISMIC_FIELD_DIGITAL_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_T3D_SEISMIC_FIELD_DIGITAL_DATA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE SEISMIC_INTERPRETATION_DATA_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_SEISMIC_INTERPRETATION_DATA_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_SEISMIC_INTERPRETATION_DATA_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
                CREATE TABLE DIGITAL_2D_SEISMIC_SECTION_AFE (
                AFE_NUMBER INT,
                WORKSPACE_NAME VARCHAR(255),
                KKKS_NAME VARCHAR(255),
                WORKING_AREA VARCHAR(255),
                ...
                CONSTRAINT FK_DIGITAL_2D_SEISMIC_SECTION_SUBMISSION_TYPE FOREIGN KEY (SUBMISSION_TYPE)
                    REFERENCES SUBMISSION (SUBMISSION_TYPE),
                CONSTRAINT FK_DIGITAL_2D_SEISMIC_SECTION_EMAIL FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL)
                );
