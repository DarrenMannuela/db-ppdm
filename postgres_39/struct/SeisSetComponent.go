...
type Seis_set_component struct {
	...
	Seis_act_obs_no           *int       `json:"seis_act_obs_no"`
	Seis_act_seis_set_id      *string    `json:"seis_act_seis_set_id"`
	Seis_act_seis_set_subtype *string    `json:"seis_act_seis_set_subtype"`
	...
	Uwi                       *string    `json:"uwi"`
	Well_act_obs_no           *int       `json:"well_act_obs_no"`
	Well_act_set_id           *string    `json:"well_act_set_id"`
	Well_act_source           *string    `json:"well_act_source"`
	Well_act_type             *string    `json:"well_act_type"`
	Well_act_uwi              *string    `json:"well_act_uwi"`
