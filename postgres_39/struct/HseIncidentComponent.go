...
type Hse_incident_component struct {
	...
	Crew_member_obs_no        *int       `json:"crew_member_obs_no"`
	...
	Pden_activity_type        *string    `json:"pden_activity_type"`
	Pden_amendment_seq_no     *int       `json:"pden_amendment_seq_no"`
	Pden_id                   *string    `json:"pden_id"`
	Pden_period_id            *string    `json:"pden_period_id"`
	Pden_period_type          *string    `json:"pden_period_type"`
	Pden_source               *string    `json:"pden_source"`
	Pden_subtype              *string    `json:"pden_subtype"`
	Pden_volume_date          *time.Time `json:"pden_volume_date"`
	Pden_volume_date_desc     *string    `json:"pden_volume_date_desc"`
	Pden_volume_method        *string    `json:"pden_volume_method"`
	...
	Total_incident_count      *int       `json:"total_incident_count"`
	Total_incident_period     *float64   `json:"total_incident_period"`
	Total_incident_period_uom *string    `json:"total_incident_period_uom"`
	Uwi                       *string    `json:"uwi"`
