...
type Ppdm_sw_applic_comp struct {
	...
	Sample_source            *string    `json:"sample_source"`
	...
	Well_core_desc_id        *string    `json:"well_core_desc_id"`
	Well_test_id             *string    `json:"well_test_id"`
	Well_test_recovery_id    *string    `json:"well_test_recovery_id"`
