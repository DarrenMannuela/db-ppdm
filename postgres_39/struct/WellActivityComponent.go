...
type Well_activity_component struct {
	Uwi                      string     `json:"uwi"`
	Activity_source          string     `json:"activity_source"`
	...
	Ba_service_provided_by   *string    `json:"ba_service_provided_by"`
	...
	Maint_equipment_id       *string    `json:"maint_equipment_id"`
	Maint_equip_maint_id     *string    `json:"maint_equip_maint_id"`
	...
	Plugback_source          *string    `json:"plugback_source"`
