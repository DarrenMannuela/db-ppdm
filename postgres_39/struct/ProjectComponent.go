...
type Project_component struct {
	...
	Field_strat_interp_id    *string    `json:"field_strat_interp_id"`
	...
	Other_project_id         *string    `json:"other_project_id"`
	...
	Reserve_product_type     *string    `json:"reserve_product_type"`
	...
	Well_int_interp_id       *string    `json:"well_int_interp_id"`
	Well_int_source          *string    `json:"well_int_source"`
	Well_int_strat_unit_id   *string    `json:"well_int_strat_unit_id"`
	Well_int_uwi             *string    `json:"well_int_uwi"`
