...
type Strat_column_acqtn struct {
	...
	Strat_column_acqtn_id string  `json:"strat_column_acqtn_id" default:"source"`
	...
	Field_interp_id       *string `json:"field_interp_id" default:""`
	...
	Ws_interp_id          *string `json:"ws_interp_id" default:""`
	Ws_strat_unit_id      *string `json:"ws_strat_unit_id" default:""`
