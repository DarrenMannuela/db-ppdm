...
type Prod_string_component struct {
	Uwi                        string  `json:"uwi" default:"source"`
	Pr_str_source              string  `json:"pr_str_source" default:"source"`
	...
	Prod_string_component_type *string `json:"prod_string_component_type" default:""`
