...
type Well_activity_component struct {
	Uwi                      string  `json:"uwi" default:"source"`
	Activity_source          string  `json:"activity_source" default:"source"`
	...
	Ba_service_provided_by   *string `json:"ba_service_provided_by" default:""`
	Ba_service_seq_no        *int    `json:"ba_service_seq_no" default:""`
	Bit_interval_obs_no      *int    `json:"bit_interval_obs_no" default:""`
	Bit_source               *string `json:"bit_source" default:""`
	...
	Cement_obs_no            *int    `json:"cement_obs_no" default:""`
	...
	Drill_bit_period_obs_no  *int    `json:"drill_bit_period_obs_no" default:""`
	Drill_check_obs_no       *int    `json:"drill_check_obs_no" default:""`
	...
	Maint_equipment_id       *string `json:"maint_equipment_id" default:""`
	Maint_equip_maint_id     *string `json:"maint_equip_maint_id" default:""`
	...
	Perforation_obs_no       *int    `json:"perforation_obs_no" default:""`
	Perforation_source       *string `json:"perforation_source" default:""`
	Period_obs_no            *int    `json:"period_obs_no" default:""`
	Physical_item_id         *string `json:"physical_item_id" default:""`
	Plugback_obs_no          *int    `json:"plugback_obs_no" default:""`
	Plugback_source          *string `json:"plugback_source" default:""`
	...
	Well_core_source         *string `json:"well_core_source" default:""`
