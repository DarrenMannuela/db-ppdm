...
type Strat_well_acqtn struct {
	Strat_well_acqtn_id     string  `json:"strat_well_acqtn_id" default:"source"`
	...
	Field_strat_name_set_id *string `json:"field_strat_name_set_id" default:""`
	...
	Sc_interp_id            *string `json:"sc_interp_id" default:""`
	Sc_strat_unit_id        *string `json:"sc_strat_unit_id" default:""`
