...
type Ra_seis_activity_type struct {
	Seis_activity_class string  `json:"seis_activity_class" default:"source"`
	Seis_activity_type  string  `json:"seis_activity_type" default:"source"`
