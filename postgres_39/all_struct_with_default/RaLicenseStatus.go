...
type Ra_license_status struct {
	License_status_type string  `json:"license_status_type" default:"source"`
	License_status      string  `json:"license_status" default:"source"`
