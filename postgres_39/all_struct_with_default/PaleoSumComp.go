...
type Paleo_sum_comp struct {
	Paleo_summary_id             string  `json:"paleo_summary_id" default:"source"`
	Paleo_component_id           string  `json:"paleo_component_id" default:"source"`
	...
	Paleo_summary_component_type *string `json:"paleo_summary_component_type" default:""`
