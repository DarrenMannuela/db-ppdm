...
type Int_set_component struct {
	...
	Land_offering_bid        *string `json:"land_offering_bid" default:""`
	...
	Pden_disposition_obs_no  *int    `json:"pden_disposition_obs_no" default:""`
	...
	Trigger_desc             *string `json:"trigger_desc" default:""`
	Trigger_event            *string `json:"trigger_event" default:""`
