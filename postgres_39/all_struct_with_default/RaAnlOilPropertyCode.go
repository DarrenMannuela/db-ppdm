...
type Ra_anl_oil_property_code struct {
	Analysis_property   string  `json:"analysis_property" default:"source"`
	Property_value_code string  `json:"property_value_code" default:"source"`
