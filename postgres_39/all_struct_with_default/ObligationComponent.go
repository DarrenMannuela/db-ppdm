...
type Obligation_component struct {
	...
	Ba_service_ba_id          *string `json:"ba_service_ba_id" default:""`
	Ba_service_provider       *string `json:"ba_service_provider" default:""`
	Ba_service_seq_no         *int    `json:"ba_service_seq_no" default:""`
	...
	Contract_extension_id     *string `json:"contract_extension_id" default:""`
	Contract_id               *string `json:"contract_id" default:""`
	Contract_provision_id     *string `json:"contract_provision_id" default:""`
	Cont_service_ba_id        *string `json:"cont_service_ba_id" default:""`
	Cont_service_seq_no       *int    `json:"cont_service_seq_no" default:""`
	...
	Facility_service_ba_id    *string `json:"facility_service_ba_id" default:""`
	Facility_service_seq_no   *int    `json:"facility_service_seq_no" default:""`
	...
	Fulfilled_remark          *string `json:"fulfilled_remark" default:""`
	...
	Land_cost_id              *string `json:"land_cost_id" default:""`
	Land_offering_bid_id      *string `json:"land_offering_bid_id" default:""`
	...
	Land_service_provided_by  *string `json:"land_service_provided_by" default:""`
	Land_service_seq_no       *int    `json:"land_service_seq_no" default:""`
	...
	Lr_termination_id         *string `json:"lr_termination_id" default:""`
	Lr_termination_seq_no     *int    `json:"lr_termination_seq_no" default:""`
	Notification_id           *string `json:"notification_id" default:""`
	Obligation_component_type *string `json:"obligation_component_type" default:""`
	...
	Seis_point_flow_id        *string `json:"seis_point_flow_id" default:""`
	Seis_point_id             *string `json:"seis_point_id" default:""`
	Seis_service_ba_id        *string `json:"seis_service_ba_id" default:""`
	Seis_service_seq_no       *int    `json:"seis_service_seq_no" default:""`
	...
	Well_service_ba_id        *string `json:"well_service_ba_id" default:""`
	Well_service_seq_no       *int    `json:"well_service_seq_no" default:""`
	Well_set_id               *string `json:"well_set_id" default:""`
	Work_order_delivery_id    *string `json:"work_order_delivery_id" default:""`
