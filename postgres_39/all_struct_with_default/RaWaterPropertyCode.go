...
type Ra_water_property_code struct {
	Water_property      string  `json:"water_property" default:"source"`
	Water_property_code string  `json:"water_property_code" default:"source"`
