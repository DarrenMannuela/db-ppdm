...
type Ppdm_metric_component struct {
	...
	Metric_component_type    *string `json:"metric_component_type" default:""`
	Metric_obs_no            *int    `json:"metric_obs_no" default:""`
	...
	Schema_entity_id         *string `json:"schema_entity_id" default:""`
	...
	Well_activity_uwi        *string `json:"well_activity_uwi" default:""`
