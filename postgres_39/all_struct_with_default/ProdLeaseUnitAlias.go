...
type Prod_lease_unit_alias struct {
	Lease_unit_id            string  `json:"lease_unit_id" default:"source"`
	Lease_unit_source        string  `json:"lease_unit_source" default:"source"`
	Prod_lease_unit_alias_id string  `json:"prod_lease_unit_alias_id" default:"source"`
	Alias_source             string  `json:"alias_source" default:"source"`
