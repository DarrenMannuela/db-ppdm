...
type Sp_parcel_pbl struct {
	Parcel_pbl_id          string  `json:"parcel_pbl_id" default:"source"`
	...
	Pbl_block              *string `json:"pbl_block" default:""`
	Pbl_lot                *string `json:"pbl_lot" default:""`
	Pbl_plan               *string `json:"pbl_plan" default:""`
	Pbl_subdivision        *string `json:"pbl_subdivision" default:""`
