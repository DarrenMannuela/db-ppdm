...
type Contract_component struct {
	...
	Contract_component_type  *string `json:"contract_component_type" default:""`
	...
	Land_right_acqtn_id      *string `json:"land_right_acqtn_id" default:""`
