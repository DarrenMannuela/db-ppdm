...
type Ent_component struct {
	...
	Ent_comp_type            *string `json:"ent_comp_type" default:""`
	Ent_rule                 *string `json:"ent_rule" default:""`
	...
	Report_hierarchy_id      *string `json:"report_hierarchy_id" default:""`
	Report_hier_component_id *string `json:"report_hier_component_id" default:""`
	...
	Transaction_type         *string `json:"transaction_type" default:""`
