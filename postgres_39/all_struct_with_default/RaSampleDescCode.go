...
type Ra_sample_desc_code struct {
	Description_type   string  `json:"description_type" default:"source"`
	Description_code   string  `json:"description_code" default:"source"`
