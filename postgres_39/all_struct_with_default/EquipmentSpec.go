...
type Equipment_spec struct {
	...
	Ratio_name           *string  `json:"ratio_name" default:""`
	Ratio_value_average  *float64 `json:"ratio_value_average" default:""`
	Ratio_value_maximum  *float64 `json:"ratio_value_maximum" default:""`
	Ratio_value_minimum  *float64 `json:"ratio_value_minimum" default:""`
