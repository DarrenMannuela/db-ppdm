...
type Ra_inst_detail_code struct {
	Instrument_detail_type string  `json:"instrument_detail_type" default:"source"`
	Instrument_detail_code string  `json:"instrument_detail_code" default:"source"`
