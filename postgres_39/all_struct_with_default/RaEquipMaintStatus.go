...
type Ra_equip_maint_status struct {
	Maintain_status_type string  `json:"maintain_status_type" default:"source"`
	Maintain_status      string  `json:"maintain_status" default:"source"`
