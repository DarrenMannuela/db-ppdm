...
type Ba_organization_comp struct {
	...
	Ba_organization_component_type *string `json:"ba_organization_component_type" default:""`
	...
	Organization_id2               *string `json:"organization_id_2" default:""`
	Organization_seq_no2           *int    `json:"organization_seq_no_2" default:""`
