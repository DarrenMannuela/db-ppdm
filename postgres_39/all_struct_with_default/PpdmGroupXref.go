...
type Ppdm_group_xref struct {
	Parent_group_id    string  `json:"parent_group_id" default:"source"`
	Child_group_id     string  `json:"child_group_id" default:"source"`
	Xref_obs_no        int     `json:"xref_obs_no" default:"1"`
	Active_ind         *string `json:"active_ind" default:""`
	Effective_date     *string `json:"effective_date" default:""`
	Expiry_date        *string `json:"expiry_date" default:""`
	Group_xref_type    *string `json:"group_xref_type" default:""`
