...
type Anl_paleo struct {
	...
	Palynology_obs_no      int      `json:"palynology_obs_no" default:"1"`
	Active_ind             *string  `json:"active_ind" default:""`
	Amount_type            *string  `json:"amount_type" default:""`
	...
	Sample_total_value     *float64 `json:"sample_total_value" default:""`
	Sample_total_value_uom *string  `json:"sample_total_value_uom" default:""`
	Source                 *string  `json:"source" default:""`
	Step_seq_no            *int     `json:"step_seq_no" default:""`
	Substance_id           *string  `json:"substance_id" default:""`
	Total_value            *float64 `json:"total_value" default:""`
	Total_value_ouom       *string  `json:"total_value_ouom" default:""`
