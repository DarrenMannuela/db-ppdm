...
func PatchT3DSeismicFieldDigitalData(c *fiber.Ctx) error{
    ...
    if idExist != ""{
        if tsfddt.Ba_long_name != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET ba_long_name = :1 WHERE id = :2`, tsfddt.Ba_long_name, id)
        ...
        if tsfddt.Ba_type != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET ba_type = :1 WHERE id = :2`, tsfddt.Ba_type, id)
        ...
        if tsfddt.Area_id != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET area_id = :1 WHERE id = :2`, tsfddt.Area_id, id)
        ...
        if tsfddt.Area_type != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET area_type = :1 WHERE id = :2`, tsfddt.Area_type, id)
        ...
        if tsfddt.Acqtn_survey_name != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET acqtn_survey_name = :1 WHERE id = :2`, tsfddt.Acqtn_survey_name, id)
        ...
        if tsfddt.Start_date != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET start_date = :1 WHERE id = :2`, tsfddt.Start_date, id)
        ...
        if tsfddt.Shot_by != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET shot_by = :1 WHERE id = :2`, tsfddt.Shot_by, id)
        ...
        if tsfddt.Rcrd_rec_length != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET rcrd_rec_length = :1 WHERE id = :2`, tsfddt.Rcrd_rec_length, id)
        ...
        if tsfddt.Rcrd_rec_length_ouom != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET rcrd_rec_length_ouom = :1 WHERE id = :2`, tsfddt.Rcrd_rec_length_ouom, id)
        ...
        if tsfddt.Rcrd_sample_rate != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET rcrd_sample_rate = :1 WHERE id = :2`, tsfddt.Rcrd_sample_rate, id)
        ...
        if tsfddt.Rcrd_sample_rate_ouom != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET rcrd_sample_rate_ouom = :1 WHERE id = :2`, tsfddt.Rcrd_sample_rate_ouom, id)
        ...
        if tsfddt.First_seis_point_id != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET first_seis_point_id = :1 WHERE id = :2`, tsfddt.First_seis_point_id, id)
        ...
        if tsfddt.Last_seis_point_id != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET last_seis_point_id = :1 WHERE id = :2`, tsfddt.Last_seis_point_id, id)
        ...
        if tsfddt.Create_date != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET create_date = :1 WHERE id = :2`, tsfddt.Create_date, id)
        ...
        if tsfddt.Proc_set_type != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET proc_set_type = :1 WHERE id = :2`, tsfddt.Proc_set_type, id)
        ...
        if tsfddt.Field_file_number != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET field_file_number = :1 WHERE id = :2`, tsfddt.Field_file_number, id)
        ...
        if tsfddt.Tape_number != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET tape_number = :1 WHERE id = :2`, tsfddt.Tape_number, id)
        ...
        if tsfddt.Rcrd_format_type != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET rcrd_format_type = :1 WHERE id = :2`, tsfddt.Rcrd_format_type, id)
        ...
        if tsfddt.Ba_long_name_2 != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET ba_long_name_2 = :1 WHERE id = :2`, tsfddt.Ba_long_name_2, id)
        ...
        if tsfddt.Ba_type_2 != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET ba_type_2 = :1 WHERE id = :2`, tsfddt.Ba_type_2, id)
        ...
        if tsfddt.Data_store_name != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET data_store_name = :1 WHERE id = :2`, tsfddt.Data_store_name, id)
        ...
        if tsfddt.Original_file_name != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET original_file_name = :1 WHERE id = :2`, tsfddt.Original_file_name, id)
        ...
        if tsfddt.Password != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET password = :1 WHERE id = :2`, tsfddt.Password, id)
        ...
        if tsfddt.Digital_size != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET digital_size = :1 WHERE id = :2`, tsfddt.Digital_size, id)
        ...
        if tsfddt.Digital_size_uom != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET digital_size_uom = :1 WHERE id = :2`, tsfddt.Digital_size_uom, id)
        ...
        if tsfddt.Remark != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET remark = :1 WHERE id = :2`, tsfddt.Remark, id)
        ...
        if tsfddt.Source != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET source = :1 WHERE id = :2`, tsfddt.Source, id)
        ...
        if tsfddt.Qc_status != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET qc_status = :1 WHERE id = :2`, tsfddt.Qc_status, id)
        ...
        if tsfddt.Checked_by_ba_id != nil{
             _, err = tx.Exec(`UPDATE t3d_seismic_field_digital_data_table SET checked_by_ba_id = :1 WHERE id = :2`, tsfddt.Checked_by_ba_id, id)
