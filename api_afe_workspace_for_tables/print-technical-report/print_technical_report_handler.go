...
func PatchPrintTechnicalReport(c *fiber.Ctx) error{
    ...
    if idExist != ""{
        if ptrt.Ba_long_name != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET ba_long_name = :1 WHERE id = :2`, ptrt.Ba_long_name, id)
        ...
        if ptrt.Ba_type != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET ba_type = :1 WHERE id = :2`, ptrt.Ba_type, id)
        ...
        if ptrt.Area_id != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET area_id = :1 WHERE id = :2`, ptrt.Area_id, id)
        ...
        if ptrt.Area_type != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET area_type = :1 WHERE id = :2`, ptrt.Area_type, id)
        ...
        if ptrt.Title != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET title = :1 WHERE id = :2`, ptrt.Title, id)
        ...
        if ptrt.Creator_name != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET creator_name = :1 WHERE id = :2`, ptrt.Creator_name, id)
        ...
        if ptrt.Create_date != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET create_date = :1 WHERE id = :2`, ptrt.Create_date, id)
        ...
        if ptrt.Page_count != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET page_count = :1 WHERE id = :2`, ptrt.Page_count, id)
        ...
        if ptrt.Media_type != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET media_type = :1 WHERE id = :2`, ptrt.Media_type, id)
        ...
        if ptrt.Document_type != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET document_type = :1 WHERE id = :2`, ptrt.Document_type, id)
        ...
        if ptrt.Item_category != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET item_category = :1 WHERE id = :2`, ptrt.Item_category, id)
        ...
        if ptrt.Item_sub_category != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET item_sub_category = :1 WHERE id = :2`, ptrt.Item_sub_category, id)
        ...
        if ptrt.Ba_long_name_2 != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET ba_long_name_2 = :1 WHERE id = :2`, ptrt.Ba_long_name_2, id)
        ...
        if ptrt.Ba_type_2 != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET ba_type_2 = :1 WHERE id = :2`, ptrt.Ba_type_2, id)
        ...
        if ptrt.Data_store_name != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET data_store_name = :1 WHERE id = :2`, ptrt.Data_store_name, id)
        ...
        if ptrt.Data_store_type != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET data_store_type = :1 WHERE id = :2`, ptrt.Data_store_type, id)
        ...
        if ptrt.Location_id != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET location_id = :1 WHERE id = :2`, ptrt.Location_id, id)
        ...
        if ptrt.Remark != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET remark = :1 WHERE id = :2`, ptrt.Remark, id)
        ...
        if ptrt.Source != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET source = :1 WHERE id = :2`, ptrt.Source, id)
        ...
        if ptrt.Qc_status != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET qc_status = :1 WHERE id = :2`, ptrt.Qc_status, id)
        ...
        if ptrt.Checked_by_ba_id != nil{
             _, err = tx.Exec(`UPDATE print_technical_report_table SET checked_by_ba_id = :1 WHERE id = :2`, ptrt.Checked_by_ba_id, id)
