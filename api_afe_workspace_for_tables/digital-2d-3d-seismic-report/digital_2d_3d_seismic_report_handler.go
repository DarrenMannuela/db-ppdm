...
func PatchDigital2D3DSeismicReport(c *fiber.Ctx) error{
    ...
    if idExist != ""{
        if d23srt.Ba_long_name != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET ba_long_name = :1 WHERE id = :2`, d23srt.Ba_long_name, id)
        ...
        if d23srt.Ba_type != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET ba_type = :1 WHERE id = :2`, d23srt.Ba_type, id)
        ...
        if d23srt.Area_id != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET area_id = :1 WHERE id = :2`, d23srt.Area_id, id)
        ...
        if d23srt.Area_type != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET area_type = :1 WHERE id = :2`, d23srt.Area_type, id)
        ...
        if d23srt.Acqtn_survey_name != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET acqtn_survey_name = :1 WHERE id = :2`, d23srt.Acqtn_survey_name, id)
        ...
        if d23srt.Start_date != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET start_date = :1 WHERE id = :2`, d23srt.Start_date, id)
        ...
        if d23srt.Seis_dimension != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET seis_dimension = :1 WHERE id = :2`, d23srt.Seis_dimension, id)
        ...
        if d23srt.Line_name != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET line_name = :1 WHERE id = :2`, d23srt.Line_name, id)
        ...
        if d23srt.Title != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET title = :1 WHERE id = :2`, d23srt.Title, id)
        ...
        if d23srt.Creator_name != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET creator_name = :1 WHERE id = :2`, d23srt.Creator_name, id)
        ...
        if d23srt.Create_date != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET create_date = :1 WHERE id = :2`, d23srt.Create_date, id)
        ...
        if d23srt.Item_category != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET item_category = :1 WHERE id = :2`, d23srt.Item_category, id)
        ...
        if d23srt.Digital_format != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET digital_format = :1 WHERE id = :2`, d23srt.Digital_format, id)
        ...
        if d23srt.Media_type != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET media_type = :1 WHERE id = :2`, d23srt.Media_type, id)
        ...
        if d23srt.Ba_long_name_2 != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET ba_long_name_2 = :1 WHERE id = :2`, d23srt.Ba_long_name_2, id)
        ...
        if d23srt.Ba_type_2 != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET ba_type_2 = :1 WHERE id = :2`, d23srt.Ba_type_2, id)
        ...
        if d23srt.Data_store_name != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET data_store_name = :1 WHERE id = :2`, d23srt.Data_store_name, id)
        ...
        if d23srt.Original_file_name != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET original_file_name = :1 WHERE id = :2`, d23srt.Original_file_name, id)
        ...
        if d23srt.Password != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET password = :1 WHERE id = :2`, d23srt.Password, id)
        ...
        if d23srt.Digital_size != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET digital_size = :1 WHERE id = :2`, d23srt.Digital_size, id)
        ...
        if d23srt.Digital_size_uom != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET digital_size_uom = :1 WHERE id = :2`, d23srt.Digital_size_uom, id)
        ...
        if d23srt.Remark != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET remark = :1 WHERE id = :2`, d23srt.Remark, id)
        ...
        if d23srt.Source != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET source = :1 WHERE id = :2`, d23srt.Source, id)
        ...
        if d23srt.Qc_status != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET qc_status = :1 WHERE id = :2`, d23srt.Qc_status, id)
        ...
        if d23srt.Checked_by_ba_id != nil{
             _, err = tx.Exec(`UPDATE digital_2d_3d_seismic_report_table SET checked_by_ba_id = :1 WHERE id = :2`, d23srt.Checked_by_ba_id, id)
